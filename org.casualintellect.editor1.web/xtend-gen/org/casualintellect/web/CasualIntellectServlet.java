...
import org.casualintellect.web.CasualIntellectWebSetup;
...
public class CasualIntellectServlet extends XtextServlet {
  ...
  public void init() {
    try {
      ...
      CasualIntellectWebSetup _casualIntellectWebSetup = new CasualIntellectWebSetup(executorServiceProvider);
      _casualIntellectWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
